VER como ejemplo : https://www.youtube.com/watch?v=ZpY5KdGQvwI&ab_channel=midudev



para nuestro servicio, 2 establecimientos seran coincidencia si tienen el mismo nombre y misma provincia de ubicacion.

podriamos comparar por ID. tambien. ID + nombre.
